...
namespace Desafio3.Migrations
{
    ...
    [Migration("20241005173222_MigracionInicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Desafio3.Models.EquipoT", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Desafio3.Models.ProyectoT", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Desafio3.Models.TareaT", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Desafio3.Models.ProyectoT", b =>
                {
                    b.HasOne("Desafio3.Models.EquipoT", "Equipo")
                        .WithMany("Proyectos")
            ...
            modelBuilder.Entity("Desafio3.Models.TareaT", b =>
                {
                    b.HasOne("Desafio3.Models.ProyectoT", "Proyecto")
                        .WithMany("Tareas")
